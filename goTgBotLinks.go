...
var goTgBotLinks = []buttonLink{
	...
	{
		Name: "Как я Бота на GO писал",
		Link: "https://ashirobokov.wordpress.com/2016/10/14/dnd-spells-telegram-bot-2/",
	},
	{
		Name: "Видео Создаем бота",
		Link: "https://www.youtube.com/watch?v=AJdHRBG8sT4",
	},
	{
		Name: "Практикум на skillbox",
	...
	{
		Name: "Полезная либа",
		Link: "https://github.com/tucnak/telebot",
	},
}
